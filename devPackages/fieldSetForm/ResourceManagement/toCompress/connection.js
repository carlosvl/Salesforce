/*
Salesforce.com AJAX Connector 15.0
    ...
    for (var f in this) {
        if ("_name" == f || "_xsiType" == f) {
            ...
            if (typeof val != "function") {
                if (typeof val == "array") {
                    for (var aval in val) {
                        this.writeValue(sobjectNs, writer, f, aval);
                    }
                } else {
...
sforce.internal.Debug = function() {
    ...
    this.println = function(s, type) {
        ...
        if (this.win === null || !this.win.document) {
            this.output = null;
            this.win = window.open((typeof window.UserContext != "undefined") ? UserContext.getUrl('/soap/ajax/15.0/debugshell.html') : '/soap/ajax/15.0/debugshell.html', '',
    ...
    this.traceCallback = function() {
        ...
        for (var el in sforce.debug.traceQueue) {
            var element = sforce.debug.traceQueue[el];
...
sforce.Connection = function() {
    ...
    this.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("/services/Soap/u/15.0") : "/services/Soap/u/15.0";
};
...
sforce.connection.serverUrl = (typeof window.UserContext != "undefined") ? UserContext.getUrl("/services/Soap/u/15.0") : "/services/Soap/u/15.0";
